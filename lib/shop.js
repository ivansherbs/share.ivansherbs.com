...
const hashKey = config.get('shops.give.hashKey');
const productDatabasePath = config.get('shops.give.productDatabasePath');
const productTemplatePath = config.get('shops.give.productTemplatePath');
